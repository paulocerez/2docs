export const getParsingPrompt = () => {
	return `You are an AI assistant specialized in extracting comprehensive API endpoint information from markdown documentation. Your task is to thoroughly analyze the given markdown and return a complete JSON array of objects, where each object represents an API endpoint.
